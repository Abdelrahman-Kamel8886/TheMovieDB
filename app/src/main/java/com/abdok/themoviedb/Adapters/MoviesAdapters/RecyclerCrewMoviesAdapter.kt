...
class RecyclerCrewMoviesAdapter : RecyclerView.Adapter<RecyclerCrewMoviesAdapter.Holder>() {


    var list : List<PersonMoviesCrew> ?= null
    var onItemClicked : ((Int) -> Unit) ?= null


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val binding = ItemPersonMovieBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class Holder(val binding: ItemPersonMovieBinding) : RecyclerView.ViewHolder(binding.root) {
